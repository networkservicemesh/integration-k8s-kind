...
//replace github.com/networkservicemesh/gotestmd => ../gotestmd

replace github.com/networkservicemesh/integration-tests => github.com/NikitaSkrynnik/integration-tests v0.0.0-20230530074058-96c6014ac147
